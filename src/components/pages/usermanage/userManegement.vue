    ...
    <div class="userManage">
        ...
        <div class="content_box">
            <div class="search_box">
                ...
                <div class="input_box">
                    <el-input placeholder="查找用户" size="small" v-model="name" class="input-with-select">
            ...
            <div class="table_box">
                <el-table ref="multipleTable" :data="rows" tooltip-effect="dark" style="width: 100%;font-size:12px">
                    ...
                    <el-table-column prop="contact" label="联系人姓名" min-width="150" align="center">
					</el-table-column>
                    <el-table-column prop="contactPhone" label="联系人电话" min-width="150" align="center">
					</el-table-column>
        ...
        <el-dialog center title="编辑用户信息" width="800px" :visible.sync="editUserVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="用户密码：" prop="password">
                    <el-input type="password" v-model="editForm.password" disabled size="small" auto-complete="off" placeholder="请设置登录密码（至少6位字符）"></el-input>
				</el-form-item>
				<el-form-item label="公司名称：" prop="orgName">
            ...
            this.$refs[formName].validate((valid) => {
                if(valid) {
                    let para ={
                        ...
                        password: this.editForm.password,               //用户密码
