    ...
    <div class="login_box">
        <div class="login_t_box">
            ...
            <div class="login_form_box">
                ...
                <h3>新用户注册</h3>
                <el-form ref="AccountFrom" :model="account" :rules="rules" class="inp_box reg_box">
                    ...
                    <el-form-item style="width:100%;">
                        <el-button type="primary" class="_btn" style="width:100%;" @click.native.prevent="showMsg">提交审核</el-button>
                    </el-form-item>
                    <!-- <el-form-item>
